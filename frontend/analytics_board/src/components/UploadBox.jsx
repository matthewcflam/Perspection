...
export default function UploadBox({
  ...
  const uploadIcon = (
    ...
    >
      <path d="M12 16c-.55 0-1-.45-1-1V9.83l-1.59 1.58a.996.996 0 11-1.41-1.41l3.3-3.29c.39-.39 
      1.03-.39 1.42 0l3.3 3.29a.996.996 0 11-1.41 1.41L13 9.83V15c0 .55-.45 
      1-1 1zm8-4c-.55 0-1 .45-1 1v5H5v-5c0-.55-.45-1-1-1s-1 .45-1 1v6c0 
      1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-6c0-.55-.45-1-1-1z"/>
    </svg>
  );
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center z-10">
        ...
        {uploaded === "loading" ? (
          <span className="text-lg text-white/80 animate-pulse">Uploading…</span>
        ) : (
          <>
            <span className="text-xl font-semibold mt-1">{label}</span>
            <span className="text-sm opacity-70">
              {uploaded ? "Click or drag to upload" : "Click or drag to upload"}
            </span>
          </>
        )}
      </div>
