...
A popup message must appear stating: “This username already exists.” Both Username and Password fields must be set to empty. A 401 Unauthorized error must be set and logged.
